...
public class BluetoothDeviceList extends Activity {
    ...
    private void startDeviceDiscover() {
    ...
    private AdapterView.OnItemClickListener deviceSelect

...
class CalculateCoords:
    ...
    # directly straight
    def displacement_straight(self, displacement: int, orientation: Orientation) -> Coord:
    ...
    def displacement_straight_left(self, displacement: int, orientation: Orientation) -> Coord: 
        if orientation == Orientation.NORTH:
    ...
    def displacement_straight_right(self, displacement: int, orientation: Orientation) -> Coord:
        if orientation == Orientation.NORTH:
            if 0 <= self.x+1 < MAP_COL and 0 <= self.y + displacement < MAP_ROW:
                return Coord(self.x+1, self.y + displacement)
        elif orientation == Orientation.EAST:
    ...
    # directly left
    def displacement_left(self, displacement: int, orientation: Orientation) -> Coord:
        if orientation == Orientation.NORTH:
            if 0 <= self.x - displacement < MAP_COL:
                return Coord(self.x - displacement , self.y)
        elif orientation == Orientation.EAST:
    ...
    def displacement_left_up(self, displacement: int, orientation: Orientation) -> Coord:
        if orientation == Orientation.NORTH:
    ...
    def displacement_left_down(self, displacement: int, orientation: Orientation) -> Coord:
        if orientation == Orientation.NORTH:
            if 0 <= self.x - displacement < MAP_COL and 0 <= self.y-1 < MAP_ROW:
                return Coord(self.x - displacement , self.y-1)
        elif orientation == Orientation.EAST:
    ...
    # directly right
    def displacement_right(self, displacement: int, orientation: Orientation) -> Coord:
        if orientation == Orientation.NORTH:
            if 0 <= self.x + displacement < MAP_COL:
                return Coord(self.x + displacement, self.y)
        elif orientation == Orientation.EAST:
    ...
    def displacement_right_top(self, displacement: int, orientation: Orientation) -> Coord:
        if orientation == Orientation.NORTH:
            if 0 <= self.x + displacement < MAP_COL and 0 <= self.y + 1 < MAP_ROW:
                return Coord(self.x + displacement, self.y+1)
        elif orientation == Orientation.EAST:
